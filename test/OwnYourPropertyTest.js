...
!developmentChains.includes(network.name)
    ...
    : describe("Nft Marketplace Unit Tests", function () {
          let connection, ownYourPropertyContract, basicNftContract, deployer, player
          ...
          beforeEach(async () => {
            ...
            // The deployer is currently the default unless changed to ownYourProperty.connect(player)
            ownYourPropertyContract = await ethers.getContract("OwnYourProperty")
            basicNftContract = await ethers.getContract("BasicNft")
            await basicNftContract.mintNft()
            await basicNftContract.approve(ownYourPropertyContract.address, TOKEN_ID)
        ...
        it("Transfer token", async function(){
          ...
          //Transfer the item
          await ownYourPropertyContract.transferItem(basicNftContract.address, TOKEN_ID, player.address)
